...
export default function VehicleInfoNav({ vehicle }: VehicleInfoNavProps) {
    return (
        <div className="sticky top-20 mt-12 border-b-2 border-b-gray-600 bg-white z-100">
            <div className="flex space-x-8 justify-between">
                ...
                <div className="flex items-center">
                    <Link href="#" className="px-4 py-2">ABOUT THE CAR</Link>
                    <Link href="#" className="px-4 py-2">FINANCE</Link>
                    <Link href="#" className="px-4 py-2">LOCATION</Link>
                    <Link
                        href=""
