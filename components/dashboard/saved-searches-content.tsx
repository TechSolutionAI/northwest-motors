            ...
            <div className="max-w-4xl mx-auto">
                ...
                {savedSearches.length === 0 ? (
                    <div className="text-center py-12 bg-gray-50 rounded-lg">
                        ...
                        <p className="text-gray-500 mb-6">You haven't saved any vehicle searches yet.</p>
                        <Link
                            href="/inventory"
                            ...
                            <div key={search.id} className="border border-gray-200 rounded-lg p-6">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        ...
                                        <p className="text-gray-500 text-sm">Saved on {search.date}</p>
                                    </div>
                                    <button
                                ...
                                <div className="flex justify-between items-center">
                                    <span className="text-gray-500">{search.results} vehicles match your criteria</span>
                                    <Link
