            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                    <div className="flex justify-center items-center pb-6">
                        ...
                        <p className="text-5xl font-light text-gray-700">01</p>
                    </div>
                ...
                <div className="text-center">
                    <div className="flex justify-center items-center pb-6">
                        <div className="border-t-4 border-gray-300 w-full mr-4 "></div>
                        <p className="text-5xl font-light text-gray-700">02</p>
                    </div>
                    <p className="text-gray-700">
                ...
                <div className="text-center">
                    <div className="flex justify-center items-center pb-6">
                        <div className="border-t-4 border-gray-300 w-full mr-4 "></div>
                        <p className="text-5xl font-light text-gray-700">03</p>
                    </div>
